...
function addChars_251658415(result_251658417, result_251658417_Idx, x_251658418, start_251658419, n_251658420) {
    ...
    Label1: do {
      ...
      Label2: do {
          Label3: while (true) {
          if (!(i_469762152 < n_251658420)) break Label3;
            iHEX60gensym4_251658435 = i_469762152;
...
function applyEvents_637534468(n_637534469) {
    ...
    Label1: do {
      ...
      colontmp__469762155 = (n_637534469.events).length;
      var i_469762156 = 0;
      Label2: do {
          Label3: while (true) {
          if (!(i_469762156 < colontmp__469762155)) break Label3;
            i_637534478 = i_469762156;
...
function applyStyle_738197986(n_738197987, s_738197988) {
    ...
    Label1: do {
      ...
      colontmp__469762159 = subInt(s_738197988.length, 1);
      var res_469762160 = 0;
      Label2: do {
          Label3: while (true) {
          if (!(res_469762160 <= colontmp__469762159)) break Label3;
            i_738198001 = res_469762160;
            n_738197987.style[s_738197988[i_738198001]] = s_738197988[addInt(i_738198001, 1)];
            res_469762160 = addInt(res_469762160, 2);
          }
      } while (false);
    } while (false);
  ...
  BeforeRet: do {
    ...
    break BeforeRet;
      ...
      Label1: do {
        ...
        Label2: do {
          var i_469762134 = 0;
          var colontmp__469762135 = 0;
          colontmp__469762135 = (n_637534497.kids).length;
          var i_469762136 = 0;
          Label3: do {
              Label4: while (true) {
              if (!(i_469762136 < colontmp__469762135)) break Label4;
                i_469762134 = i_469762136;
                k_637534609 = n_637534497.kids[chckIndx(i_469762134, 0, (n_637534497.kids).length - 1)];
    ...
    Label5: do {
      ...
      Label6: do {
        var i_469762144 = 0;
        var colontmp__469762145 = 0;
        colontmp__469762145 = subInt((n_637534497.attrs).length, 2);
        var res_469762146 = 0;
        Label7: do {
            Label8: while (true) {
            if (!(res_469762146 <= colontmp__469762145)) break Label8;
              i_469762144 = res_469762146;
              k_637534610 = n_637534497.attrs[chckIndx(i_469762144, 0, (n_637534497.attrs).length - 1)];
              v_637534611 = n_637534497.attrs[chckIndx(addInt(i_469762144, 1), 0, (n_637534497.attrs).length - 1)];
              if (!((v_637534611 == null))) {
              result_637534500.setAttribute(k_637534610, v_637534611);
              }
              
              res_469762146 = addInt(res_469762146, 2);
            }
        } while (false);
      } while (false);
    } while (false);
...
function same_637534650(n_637534651, e_637534652, nesting_637534653) {
  ...
  BeforeRet: do {
    ...
    Label3: do {
      ...
      colontmp__469762163 = len_671089340(n_637534651);
      var i_469762164 = 0;
      Label4: do {
          Label5: while (true) {
          if (!(i_469762164 < colontmp__469762163)) break Label5;
            i_637534690 = i_469762164;
...
function eq_738197758(a_738197759, b_738197760) {
  ...
  BeforeRet: do {
    ...
    Label1: do {
      var i_738197796 = 0;
      var colontmp__469762190 = 0;
      colontmp__469762190 = a_738197759.length;
      var i_469762191 = 0;
      Label2: do {
          Label3: while (true) {
          if (!(i_469762191 < colontmp__469762190)) break Label3;
            i_738197796 = i_469762191;
            if (!((a_738197759[i_738197796] == b_738197760[i_738197796]))) {
            result_738197761 = false;
            break BeforeRet;
            }
            
            i_469762191 = addInt(i_469762191, 1);
          }
      } while (false);
    } while (false);
    result_738197761 = true;
...
function sameAttrs_671089503(a_671089504, b_671089505) {
  ...
  BeforeRet: do {
    ...
    Label1: do {
      ...
      colontmp__469762194 = (a_671089504.attrs).length;
      var i_469762195 = 0;
      Label2: do {
          Label3: while (true) {
          if (!(i_469762195 < colontmp__469762194)) break Label3;
            i_671089520 = i_469762195;
...
function eq_637534704(a_637534705, b_637534706, recursive_637534707) {
  ...
  BeforeRet: do {
    ...
    Label1: do {
      ...
      colontmp__469762182 = len_671089340(a_637534705);
      var i_469762183 = 0;
      Label2: do {
          Label3: while (true) {
          if (!(i_469762183 < colontmp__469762182)) break Label3;
            i_637534725 = i_469762183;
            ...
            i_469762183 = addInt(i_469762183, 1);
          }
      } while (false);
    } while (false);
    }
    ...
    Label6: do {
      ...
      colontmp__469762186 = len_671089340(a_637534705);
      var i_469762187 = 0;
      Label7: do {
          Label8: while (true) {
          if (!(i_469762187 < colontmp__469762186)) break Label8;
            i_637534751 = i_469762187;
...
function updateAttributes_637534794(newNode_637534795, oldNode_637534796) {
    ...
    Label1: do {
      ...
      Label2: do {
        ...
        colontmp__469762200 = subInt((oldNode_637534796.attrs).length, 2);
        var res_469762201 = 0;
        Label3: do {
            Label4: while (true) {
            if (!(res_469762201 <= colontmp__469762200)) break Label4;
              i_469762199 = res_469762201;
              k_637534801 = oldNode_637534796.attrs[chckIndx(i_469762199, 0, (oldNode_637534796.attrs).length - 1)];
              __637534802 = oldNode_637534796.attrs[chckIndx(addInt(i_469762199, 1), 0, (oldNode_637534796.attrs).length - 1)];
              oldNode_637534796.dom.removeAttribute(k_637534801);
              res_469762201 = addInt(res_469762201, 2);
            }
        } while (false);
      } while (false);
    } while (false);
    Label5: do {
      ...
      Label6: do {
        ...
        colontmp__469762206 = subInt((newNode_637534795.attrs).length, 2);
        var res_469762207 = 0;
        Label7: do {
            Label8: while (true) {
            if (!(res_469762207 <= colontmp__469762206)) break Label8;
              i_469762205 = res_469762207;
              k_637534803 = newNode_637534795.attrs[chckIndx(i_469762205, 0, (newNode_637534795.attrs).length - 1)];
              v_637534804 = newNode_637534795.attrs[chckIndx(addInt(i_469762205, 1), 0, (newNode_637534795.attrs).length - 1)];
              if (!((v_637534804 == null))) {
              oldNode_637534796.dom.setAttribute(k_637534803, v_637534804);
              }
              
              res_469762207 = addInt(res_469762207, 2);
            }
        } while (false);
      } while (false);
    } while (false);
...
function getAttr_671089319(n_671089320, key_671089321) {
  ...
  BeforeRet: do {
    Label1: do {
      ...
      colontmp__469762210 = subInt((n_671089320.attrs).length, 2);
      var res_469762211 = 0;
      Label2: do {
          Label3: while (true) {
          if (!(res_469762211 <= colontmp__469762210)) break Label3;
            i_671089331 = res_469762211;
            ...
            res_469762211 = addInt(res_469762211, 2);
          }
      } while (false);
    } while (false);
  } while (false);
...
function removeAllEventHandlers_637534326(d_637534327) {
    ...
    Label1: do {
      ...
      colontmp__469762214 = d_637534327.karaxEvents.length;
      var i_469762215 = 0;
      Label2: do {
          Label3: while (true) {
          if (!(i_469762215 < colontmp__469762214)) break Label3;
            i_637534343 = i_469762215;
            d_637534327.removeEventListener(d_637534327.karaxEvents[i_637534343]["Field0"], d_637534327.karaxEvents[i_637534343]["Field1"]);
            i_469762215 = addInt(i_469762215, 1);
          }
      } while (false);
    } while (false);
    }
...
function diff_637534949(newNode_637534950, oldNode_637534951, parent_637534952, current_637534953, kxi_637534954) {
  ...
  BeforeRet: do {
    ...
    case 2:
      ...
      Label8: do {
        var i_637535019 = 0;
        var colontmp__469762169 = 0;
        colontmp__469762169 = subInt(pos_637535014, 1);
        var res_469762170 = commonPrefix_637534991;
        Label9: do {
            Label10: while (true) {
            if (!(res_469762170 <= colontmp__469762169)) break Label10;
              i_637535019 = res_469762170;
      ...
      Label11: do {
        var i_637535024 = 0;
        var res_469762173 = pos_637535014;
        Label12: do {
            Label13: while (true) {
            if (!(res_469762173 <= newPos_637535001)) break Label13;
              i_637535024 = res_469762173;
              addPatch_637534814(kxi_637534954, 2, current_637534953, null, HEX5BHEX5D_671089347(newNode_637534950, i_637535024), null);
              res_469762173 = addInt(res_469762173, 1);
            }
        } while (false);
      } while (false);
      }
        ...
        Label14: do {
          var i_637535030 = 0;
          var res_469762176 = pos_637535014;
          Label15: do {
              Label16: while (true) {
              if (!(res_469762176 <= newPos_637535001)) break Label16;
                i_637535030 = res_469762176;
                ...
                res_469762176 = addInt(res_469762176, 1);
              }
          } while (false);
        } while (false);
      }
      ...
      Label17: do {
        var i_637535035 = 0;
        var res_469762179 = pos_637535014;
        Label18: do {
            Label19: while (true) {
            if (!(res_469762179 <= oldPos_637535000)) break Label19;
              i_637535035 = res_469762179;
              ...
              res_469762179 = addInt(res_469762179, 1);
            }
        } while (false);
      } while (false);
      break;
...
function moveDom_637534879(dest_637534880, src_637534881) {
    ...
    Label1: do {
      var i_637534897 = 0;
      var colontmp__469762225 = 0;
      colontmp__469762225 = len_671089340(dest_637534880);
      var i_469762226 = 0;
      Label2: do {
          Label3: while (true) {
          if (!(i_469762226 < colontmp__469762225)) break Label3;
            i_637534897 = i_469762226;
            moveDom_637534879(HEX5BHEX5D_671089347(dest_637534880, i_637534897), HEX5BHEX5D_671089347(src_637534881, i_637534897));
            i_469762226 = addInt(i_469762226, 1);
          }
      } while (false);
    } while (false);
...
function applyPatch_637534898(kxi_637534899) {
    Label1: do {
      ...
      Label2: do {
          Label3: while (true) {
          if (!(i_469762219 < kxi_637534899.patchLen)) break Label3;
            i_637534904 = i_469762219;
    ...
    Label4: do {
      ...
      Label5: do {
          Label6: while (true) {
          if (!(i_469762222 < kxi_637534899.patchLenV)) break Label6;
            i_637534936 = i_469762222;
            ...
            i_469762222 = addInt(i_469762222, 1);
          }
      } while (false);
    } while (false);
...
function tree_671089418(kind_671089419, kids_671089420) {
  var result_671089421 = null;
    ...
    Label1: do {
      ...
      Label2: do {
          Label3: while (true) {
          if (!(i_469762230 < (kids_671089420).length)) break Label3;
            k_671089433 = kids_671089420[chckIndx(i_469762230, 0, (kids_671089420).length - 1)];
            add_671089355(result_671089421, k_671089433);
            i_469762230 = addInt(i_469762230, 1);
          }
      } while (false);
    } while (false);
  ...
  BeforeRet: do {
    ...
    n_671089282.attrs = nimCopy(null, [key_671089283, val_671089284], NTI671088909);
      ...
      Label1: do {
        ...
        colontmp__469762233 = subInt((n_671089282.attrs).length, 2);
        var res_469762234 = 0;
        Label2: do {
            Label3: while (true) {
            if (!(res_469762234 <= colontmp__469762233)) break Label3;
              i_671089301 = res_469762234;
              ...
              res_469762234 = addInt(res_469762234, 2);
            }
        } while (false);
      } while (false);
...
function create_469762057() {
  var result_469762058 = null;

    var tmp_469762089 = tree_671089418(44, []);
    add_671089355(tmp_469762089, text_671089470(makeNimstrLit("yes")));
    var tmp_469762094 = tree_671089418(190, []);
    setAttr_671089281(tmp_469762094, "method", "POST");
    setAttr_671089281(tmp_469762094, "action", "confirm");
    var tmp_469762096 = tree_671089418(21, []);
    add_671089355(tmp_469762096, text_671089470(makeNimstrLit("kf")));
    add_671089355(tmp_469762094, tmp_469762096);
    var tmp_469762097 = tree_671089418(194, []);
    setAttr_671089281(tmp_469762097, "type", "text");
    setAttr_671089281(tmp_469762097, "name", "unchi");
    valueHEX3D_671089059(tmp_469762097, "");
    setAttr_671089281(tmp_469762097, "value", "");
    add_671089355(tmp_469762097, text_671089470(makeNimstrLit("lk")));
    add_671089355(tmp_469762094, tmp_469762097);
    var tmp_469762098 = tree_671089418(195, []);
    setAttr_671089281(tmp_469762098, "type", "submit");
    add_671089355(tmp_469762098, text_671089470(makeNimstrLit("\xE9\x80\x81\xE4\xBF\xA1")));
    add_671089355(tmp_469762094, tmp_469762098);
    add_671089355(tmp_469762089, tmp_469762094);
    result_469762058 = tmp_469762089;

  return result_469762058;

}
setRenderer_637535334(create_469762057, "ROOT", null);
